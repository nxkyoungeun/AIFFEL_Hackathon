...
# 🪴업사이클링 브랜드 및 제품 추천 
## 목차
[1. 팀원 구성 및 역할](#1️⃣-팀원-구성-및-역할)<br>
[2. 프로젝트 배경](#2️⃣-프로젝트-배경)<br>
[3. 프로젝트 소개](#3️⃣-프로젝트-소개)<br>
[4. 추천시스템](#4️⃣-추천시스템)<br>
...
5. 추천시스템 종류(시도한 것들)
- 뉴럴 네트워크 임베딩
- 분류모델(로지스틱회귀, 결정트리, 랜덤포레스트, 그래디언트부스팅)
- 코사인유사도
